...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ColorChooser_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ColorChooser_t qt_meta_stringdata_ColorChooser = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ColorChooser"
QT_MOC_LITERAL(1, 13, 9), // "sendColor"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8), // "setColor"
QT_MOC_LITERAL(4, 33, 5) // "color"

    },
    "ColorChooser\0sendColor\0\0setColor\0color"
};
...
void ColorChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ColorChooser *_t = static_cast<ColorChooser *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendColor((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        ...
        {
            typedef void (ColorChooser::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorChooser::sendColor)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ColorChooser::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ColorChooser.data,
      qt_meta_data_ColorChooser,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void ColorChooser::sendColor(const QColor & _t1)
{
