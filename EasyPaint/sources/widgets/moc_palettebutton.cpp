...
QT_MOC_LITERAL(1, 14, 11), // "colorPicked"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "PaletteButton\0colorPicked\0"
};
...
void PaletteButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PaletteButton *_t = static_cast<PaletteButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (PaletteButton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PaletteButton::colorPicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PaletteButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_PaletteButton.data,
      qt_meta_data_PaletteButton,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void PaletteButton::colorPicked()
{
